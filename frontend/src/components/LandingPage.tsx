    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={onConnect}
              className="bg-[#63f7ff] text-[#002021] px-8 py-4 rounded-xl font-headline font-bold text-sm flex items-center justify-center gap-3 hover:bg-cyan-100 transition-all shadow-[0_0_20px_rgba(99,247,255,0.3)]"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path d="M21 12V7H5a2 2 0 010-4h14v4" /><path d="M3 5v14a2 2 0 002 2h16v-5" /><path d="M18 12a2 2 0 100 4 2 2 0 000-4z" /></svg>
              Connect Wallet
            </button>
            <button
              onClick={onConnect}
              className="bg-[#232b2c] text-foreground px-8 py-4 rounded-xl font-headline font-bold text-sm flex items-center justify-center gap-3 border border-[rgba(0,245,255,0.15)] hover:bg-[#2e3637] transition-all"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <h3 className="font-headline text-3xl font-semibold">The Smartest DeFi Platform</h3>
        </div>
